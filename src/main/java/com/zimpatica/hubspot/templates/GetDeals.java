...
@TemplateId(name="GetDeals")
// Set template type to READ since this integration does not have side effects
@IntegrationTemplateType(IntegrationTemplateRequestPolicy.READ)
public class GetDeals extends SimpleIntegrationTemplate {

    public static final String BASE_URL = "https://api.hubapi.com/deals/v1/deal/paged";
    ...
    protected IntegrationResponse execute(
        ...
        String url = baseUrl + "?hapikey=" + apiKey + "&properties=dealname" +"&includeAssociations=true";
        if(count!=null){
            url = url + "&limit="+count;
        }
        if(offset!=null){
