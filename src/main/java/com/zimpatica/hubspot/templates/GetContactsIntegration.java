...
@TemplateId(name="GetContactsIntegration")
// Set template type to READ since this integration does not have side effects
@IntegrationTemplateType(IntegrationTemplateRequestPolicy.READ)
public class GetContactsIntegration extends SimpleIntegrationTemplate {

    public static final String BASE_URL = "https://api.hubapi.com/contacts/v1/lists/all/contacts/all";
    ...
    protected IntegrationResponse execute(
        ...
        String url = baseUrl + "?hapikey=" + apiKey+ "&property=firstname&property=lastname&property=associatedcompanyid&property=email";
        if(count!=null){
            url = url + "&count="+count;
        }
        if(offset!=null){
